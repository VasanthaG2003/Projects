...
function turnon(){
    ...
    if(isBulbOn){
        ...
        bulb.style.boxShadow = "0px 0px 10px #daa505, 0px 10px 60px #daa505, 0px 10px 80px #daa505, 0px 10px 100px #daa505, inset 10px 0px 40px #f6c513, inset 20px 0px 60px #daad0a";
